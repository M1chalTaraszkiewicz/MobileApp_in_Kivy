...
color = "blue"
lang = "en"
pl = ["Graj", "Ustawienia", "Wyjdź", "Wisielec", "Druga", "Trzecia", "Wróć", "Różowy", "Biały", "Niebieski", "Zielony", "Polski", "English"]
en = ["Play", "Settings", "Quit", "Hangman", "Second", "Third", "Back", "Pink", "White", "Blue", "Green", "Polski", "English"]
current_lang = en
font_size = 12
...
class Settings(Screen):
    ...
    def on_language_button_click(self, instance):
        ...
        global current_lang, lang, en, pl
